...
\end{verbatim}
ein "`Taktgeber"' erzeugt werden, der alle \valunit{10}{ms} einen Wert schickt. Über \verb|_CNT8| kann dabei festgestellt werden, ob Werte übersprungen wurden, und mit \verb|_DLY8|, ob der aktuelle Wert verzögert wurde.
