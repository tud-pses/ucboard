...
\begin{table}%
	...
	{%
		\begin{tabular}{ccc}
			\mytoprule
			Value & Bandbreite [Hz] & Verzögerung [ms] \\
			\mymidrule
			\texttt{-1} & 3\,600   & 0,11 \\
			\texttt{0} & 250 & 0,97 \\
			\texttt{1} & 184 & 2,9 \\
