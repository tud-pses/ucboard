...
\subsubtitle{Rev. 0+ (Entwurf), Stand 03.11.2016}
...
\clearpage
\input{inc/hardware.tex}
\FloatBarrier

\clearpage
\input{inc/kommunikation.tex}
\FloatBarrier
...
\clearpage
\input{inc/programmierung.tex}
\FloatBarrier

\clearpage
\input{inc/schaltung.tex}
\FloatBarrier
